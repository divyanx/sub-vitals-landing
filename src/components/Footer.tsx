  ...
  return (
    <footer className="bg-[#0a0a0a] border-t border-white/[0.06] py-12 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Bottom bar */}
        <div className="pt-8 border-t border-white/[0.06] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 text-xs text-white/30">
          <span>Built for the Reddit Mod Tools Hackathon 2026</span>
          <span>
            Made with{" "}
            ...
            <a
              ...
              className="text-white/50 hover:text-[#ff4500] transition-colors"
            >
              u/divyanx_
            </a>
          </span>
